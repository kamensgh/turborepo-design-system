...
const buttonTailwind = tv({
  slots: {
    base: 'relative cursor-pointer rounded border-0 px-4 py-2 text-slate-50 transition-all duration-500',
  },
  variants: {
    variant: {
      primary: 'bg-primary outline-blue-700 hover:border-neutral-700',
      secondary: 'bg-gray-400 outline-gray-400 hover:bg-gray-600 text-black',
      success: 'bg-emerald-700 outline-emerald-700 hover:bg-emerald-600',
      danger: 'bg-red-700 outline-red-700 hover:bg-red-900',
    },
    size: {
      sm: 'text-sm',
      md: 'text-base',
